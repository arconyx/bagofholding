...
<a href="{base}/item/{item.id}">
	<li
		data-item-id={item.id}
		class="m-2 flex min-w-48 flex-col border-2 bg-slate-50 p-2 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800"
	>
